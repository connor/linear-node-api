    ...
    /***/ 66: /***/ function(
      ...
      class ClientError extends Error {
        constructor(response, request) {
          const message = `${ClientError.extractMessage(
            response
          )}: ${JSON.stringify({
            response,
            request
      ...
      class client_LinearClient {
        ...
        request(query, variables) {
          return __awaiter(this, void 0, void 0, function*() {
            ...
            const response = yield lib_default()(
            ...
            if (response.ok && !result.errors && result.data) {
              ...
              throw new ClientError(
                Object.assign(Object.assign({}, errorResult), {
      ...
      class src_Linear {
        constructor(apiKey, team_id) {
          this.client = new client_LinearClient(apiKey);
